...
Public Class rptBuildingsCustomers
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rptBuildingsCustomers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBuildingsCustomers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBuildingsCustomers = New rptBuildingsCustomers
        rpt.Site = Me.Site
        Return rpt
    End Function
