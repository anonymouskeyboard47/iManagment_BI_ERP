...
Public Class rptMeterReadingInvoice
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rptMeterReadingInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMeterReadingInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMeterReadingInvoice = New rptMeterReadingInvoice
        rpt.Site = Me.Site
        Return rpt
    End Function
