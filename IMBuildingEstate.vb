...
Public Class IMBuildingEstate


#Region "PrivateVariables"

    Private lBuildingID As Long
    Private lEstateID As Long
...
#Region "Properties"
    ...
    Public Property EstateID() As Long
        ...
        Try
            ...
            If lBuildingID = 0 Or _
                ...
                If DisplayErrorMessages = True Then
                    ...
                    ReturnError += "Please provide the Building and the Estate that you want to save"
            ...
            If Find("SELECT * FROM BuildingCostCentre WHERE " & _
            "BuildingID = " & lBuildingID, False) = True Then

                Update("UPDATE BuildingCostCentre SET " & _
                            "EstateID = " & lEstateID)
            ...
            If bSaveSuccess = True Then
                If DisplaySuccess = True Then
                    ...
                    ReturnError += "Building's Estate Saved Successfully."
            ...
            Else
                ...
                If DisplayFailure = True Then
                    ...
                    ReturnError += "'Save Building Estate' action failed." & _
        ...
        Try
            ...
            If lBuildingID = 0 Then
                ReturnError += "Cannot Delete. Please select an " & _
                    "existing Building Estate Detail"
            ...
            If bDelSuccess = True Then
                ReturnError += "Building's Estate Details Deleted"
                Return True
            Else

                ReturnError += "'Delete Building's Estate action failed"
        ...
        Try
            ...
            If lBuildingID <> 0 Then
                ...
                If bUpdateSuccess = True Then
                    ReturnError += "Building's Estate details updated Successfully"
                End If
