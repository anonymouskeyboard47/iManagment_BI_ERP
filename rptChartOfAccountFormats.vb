...
Public Class rptChartOfAccountFormats
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rptChartOfAccountFormats.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChartOfAccountFormats
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChartOfAccountFormats = New rptChartOfAccountFormats
        rpt.Site = Me.Site
        Return rpt
    End Function
