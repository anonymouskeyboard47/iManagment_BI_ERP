...
Public Class IMFixedAssetAuthorizedUsers


#Region "PrivateVariables"

    Private lFixedAssetGroupID As Long
    Private lUserGroupID As Long
...
#Region "DatabaseProcedures"
    ...
    Public Function Save(ByVal DisplayErrorMessages As Boolean, _
        ...
        Try
            ...
            If Find("SELECT * FROM FixedAssetGroupToAssetLink " & _
                ...
                " AND UserGroupID = " & lUserGroupID & ")", _
                False) = False Then
    ...
    Public Function Delete() As Boolean
        ...
        Try
            ...
            " WHERE FixedAssetGroupID = " & lFixedAssetGroupID & _
            " AND UserGroupID = " & lUserGroupID

            If lFixedAssetGroupID = 0 Or lUserGroupID = 0 Then
            ...
            Else
                ...
                ReturnError += "'Delete Fixed Asset-User Group " & _
