...
Public Class rptInventoryShortage
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rptInventoryShortage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventoryShortage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventoryShortage = New rptInventoryShortage
        rpt.Site = Me.Site
        Return rpt
    End Function
