...
Public Class rptFinancialPeriods
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rptFinancialPeriods.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFinancialPeriods
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFinancialPeriods = New rptFinancialPeriods
        rpt.Site = Me.Site
        Return rpt
    End Function
