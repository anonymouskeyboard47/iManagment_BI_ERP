...
Public Class rptSupplierDeliveryTimes
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rptSupplierDeliveryTimes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSupplierDeliveryTimes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSupplierDeliveryTimes = New rptSupplierDeliveryTimes
        rpt.Site = Me.Site
        Return rpt
    End Function
