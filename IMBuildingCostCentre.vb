...
Public Class IMBuildingCostCentre
...
#Region "GeneralProcedures"
    ...
    Public Function ReturnNumberOfBuildingsInCostCentre _
        (ByVal lValCostCentreID As Long) As Long
        ...
        Try
            ...
            With objLogin
                lReturnValue = _
                    ...
                    "SELECT Count(CostCentreID) FROM BuildingMaster " & _
                        "WHERE CostCentreID = " & lValCostCentreID)
...
#Region "DatabaseProcedures"
    ...
    Public Function SaveBuildingCostCentre _
    (ByVal DisplayErrorMessages As Boolean, _
        ...
        Try
            ...
            If FindBuildingCostCentre("SELECT * FROM BuildingCostCentre WHERE " & _
            "BuildingID = " & lBuildingID, False) = True Then

                UpdateBuildingCostCentre("UPDATE BuildingCostCentre SET " & _
            ...
            strInsertInto = "INSERT INTO BuildingCostCentre (" & _
                "BuildingID," & _
                "CostCentreID" & _
                    ") VALUES "
            ...
            If bSaveSuccess = True Then
                If DisplaySuccess = True Then
                    ...
                    ReturnError += "Building's Cost Centre Saved Successfully."
            ...
            Else
                ...
                If DisplayFailure = True Then
                    ...
                    ReturnError += "'Save Building Cost Centre' action failed." & _
    ...
    Public Function FindBuildingCostCentre(ByVal strQuery As String, _
    ...
    Public Function DeleteBuildingCostCentre _
        ...
        Try
            ...
            If lBuildingID = 0 Then
                ReturnError += "Cannot Delete. Please select an " & _
                    "existing Building Cost Centre Detail"
            ...
            strDeleteQuery = "DELETE * FROM BuildingCostCentre WHERE " & _
            ...
            If bDelSuccess = True Then
                ReturnError += "Building's Cost Centre Details Deleted"
                Return True
            Else

                ReturnError += "'Delete Building's Cost Centre action failed"
    ...
    Public Sub UpdateBuildingCostCentre(ByVal strUpQuery As String)
        ...
        Try
            ...
            If lBuildingID <> 0 Then
                ...
                If bUpdateSuccess = True Then
                    ReturnError += "Building's Cost Centre details updated Successfully"
                End If
