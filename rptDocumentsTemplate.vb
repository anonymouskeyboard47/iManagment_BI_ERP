...
Public Class rptDocumentsTemplate
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "rptDocumentsTemplate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDocumentsTemplate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDocumentsTemplate = New rptDocumentsTemplate
        rpt.Site = Me.Site
        Return rpt
    End Function
